...
{
    public class CategorySetoursConfiguration : IEntityTypeConfiguration<CategorySetoursEntity>
    {
        public void Configure(EntityTypeBuilder<CategorySetoursEntity> builder)
        {
            builder.ToTable("ge_category_setours");
