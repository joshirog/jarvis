...
{
    public class InclusionConfiguration : IEntityTypeConfiguration<InclusionEntity>
    {
        public void Configure(EntityTypeBuilder<InclusionEntity> builder)
        {
            builder.ToTable("ge_inclusions");
